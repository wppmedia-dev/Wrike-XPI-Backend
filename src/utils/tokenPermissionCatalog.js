 ...
 * on them would be a lie — the console greys those cells out rather than
...
export const MODULES = [
  ...
  },
  {
    ...
    description:
      "Wrike's own MCP tools, proxied as wrike_* — raw Wrike objects (items, spaces, approvals, comments, users, attachments) rather than XPI modules. Applies to MCP callers only; the REST API never resolves to this row.",
    actions: ALL,
  },
];
...
/**
 * An all-false matrix. For a token this is the *restricted* state — "nothing
 * granted" — and only means anything once a save has written it, since a
