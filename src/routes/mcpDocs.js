  ...
  fastify.get("/mcp-docs", async (req, reply) => {
    ...
    const steps = [
      ...
      },
      {
        ...
        text: "That's it. Your assistant can now securely work with your Wrike campaigns whenever you ask it to. What it can do depends on your token's module permissions, so an administrator can restrict which of them are available to it.",
